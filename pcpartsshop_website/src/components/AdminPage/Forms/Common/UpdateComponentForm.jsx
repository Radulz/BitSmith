...
import UpdateFormSelector from "./UpdateFormSelector";

const schema = Joi.object({
  componentId: Joi.string().guid().required(),
});

const UpdateComponentForm = ({ componentType }) => {
  ...
  return (
    <div>
      ...
      {component ? (
        <UpdateFormSelector component={component} setComponent={setComponent} />
      ) : null}
    </div>
  );
};
